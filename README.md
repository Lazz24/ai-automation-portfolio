...
AI automation systems, GTM infrastructure, and operational tooling — 17 projects built on Apollo, Zapier, OpenAI, Airtable, n8n, Make.com, Groq, Netlify, and more.
...
| [16](./16-esg-intelligence-engine/) | Magic Hat ESG Intelligence Engine | ActivePieces · Google Sheets · Groq · Resend · QuickChart | 🟡 In Development |
| [17](./17-invoice-to-crm-pipeline/) | Invoice-to-CRM Pipeline | Gmail · Make.com · Groq · Zapier · Asana | 🟡 In Development |
...
| Interfaces | Streamlit · Netlify · GitHub Pages · Cloudflare Workers · Vanilla JS |
